...
6. If workout session fails to start in background, monitoring enters **degraded mode** (`isDegradedMode = true`): passive HR query + one-shot timers still work, force-fire + haptics still fire at wake time.
